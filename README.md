...
Cachey does not use real customer, production, or private CDN traffic.

The telemetry powering Cachey is generated by [cdn-telemetry-kit](https://github.com/kganigap-291992/cdn-telemetry-kit), a deterministic CDN telemetry generator and ClickHouse ingestion pipeline. It creates CDN-like traffic with reproducible seeds, stable schema contracts, realistic request/error/cache/latency distributions, and raw plus aggregated ClickHouse tables.

This keeps the demo safe to share while preserving the operational shape of real CDN triage.
...
| Data | Synthetic CDN telemetry from [cdn-telemetry-kit](https://github.com/kganigap-291992/cdn-telemetry-kit), stored in ClickHouse MergeTree tables |
...
scripts/
  Historical/local telemetry helpers
